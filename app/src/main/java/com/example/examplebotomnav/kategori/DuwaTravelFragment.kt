...
import com.example.examplebotomnav.databinding.FragmentDuwaTravelBinding
...
class DuwaTravelFragment : Fragment() {
    private lateinit var adapter: Adapter
    private val list = ArrayList<ResultsItem>()

    private var _binding: FragmentDuwaTravelBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDuwaTravelBinding.inflate(inflater, container, false)

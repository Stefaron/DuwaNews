...
import com.example.examplebotomnav.databinding.FragmentDuwaTechBinding
...
class DuwaTechFragment : Fragment() {
    private lateinit var adapter: Adapter
    private val list = ArrayList<ResultsItem>()

    private var _binding: FragmentDuwaTechBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDuwaTechBinding.inflate(inflater, container, false)
        val root: View = binding.root

        adapter = context?.let { Adapter(list, it) }!!

        val layoutManager = LinearLayoutManager(requireContext(), LinearLayoutManager.VERTICAL, false)
        binding.rvTech.layoutManager = layoutManager
        binding.rvTech.adapter = adapter
